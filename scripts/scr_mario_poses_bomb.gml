if (duck == 0) && (shoot == 0)
{
    if (gravity == 0)
    {
        ...
        {
            sprite_index = s_mario_bomb_skid;
            image_single = 0;
            var _fx;
    ...
    {
        if (sprite_index == s_mario_bomb_run)
        {
            sprite_index = s_mario_bomb_misc;
            image_speed = 0;
            image_single = 1;
        }
        else
...
else if (shoot <> 0)
{
    ...
    {
        shoot = 2;
        sprite_index = s_mario_bomb_shoot;
        image_index = 0;
        image_speed = 0.2;
    }
